...
#Copyright(C) Randal E.Bryant, David R.O'Hallaron, 2014     #
        ...
        ##Your task is to make the pipeline work without using any forwarding##The normal bypassing logic in the file is disabled.##You can only change the pipeline control logic at the end of this file.##The trick is to make the pipeline stall whenever there is a data hazard.
                  ...
                  ? word d_srcB = [D_icode in{IOPQ, IRMMOVQ, IMRMOVQ}:D_rB;
                            ...
                            ? word d_dstE = [D_icode in{IRRMOVQ, IIRMOVQ, IOPQ}:D_rB;
                                      ...
                                      ? word d_dstM = [D_icode in{IMRMOVQ, IPOPQ}:D_rA;
                                                ...
                                                ? ##DO NOT MODIFY THE FOLLOWING CODE.##No forwarding.valA is either valP or
...
#but not condition for a generate / use hazard
                                                                !0 && IRET in{D_icode, E_icode, M_icode};
