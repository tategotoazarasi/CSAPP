...
#Copyright(C) Randal E.Bryant, David R.O'Hallaron, 2014     #
        ######################################################################This version does not detect or
        handle any hazards
                  ...
                  ? word d_srcB = [D_icode in{IOPQ, IRMMOVQ, IMRMOVQ}:D_rB;
                            ...
                            ? word d_dstE = [D_icode in{IRRMOVQ, IIRMOVQ, IOPQ}:D_rB;
                                      ...
                                      ? word d_dstM = [D_icode in{IMRMOVQ, IPOPQ}:D_rA;
                                                ...
                                                ? ##No forwarding.valA is either valP or
                                                          value from register file word d_valA =
...
#State changes only during normal operation
                                                ...
                                                ##Generate valA in execute stage word e_valA = E_valA;
#Pass valA through stage

                                                ##Set dstE to RNONE in event of not -taken conditional move word
                                                        e_dstE = [E_icode == IRRMOVQ && !e_Cnd:RNONE; 1:E_dstE;];
